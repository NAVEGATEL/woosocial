...
INSERT IGNORE INTO users (nombre_usuario, email, contraseña_encriptada, puntos, rol) VALUES
('admin', 'admin@ejemplo.com', '$2a$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 1000, 'admin');

-- Insertar algunas transacciones de ejemplo
INSERT IGNORE INTO transacciones (id_usuario, tipo, descripcion, cantidad_puntos) VALUES
(1, 'bonificacion', 'Puntos de bienvenida', 1000),
(1, 'compra', 'Compra de producto X', -50),
(1, 'venta', 'Venta de servicio Y', 200);
...
WHERE TABLE_SCHEMA = 'token_system'
ORDER BY TABLE_NAME;

-- Mostrar la estructura de las tablas principales
DESCRIBE users;
DESCRIBE transacciones;
DESCRIBE preferencias_usuario;
DESCRIBE social_media_credentials;
